...
public class InsertExample12 {
	...
	public void runMain() {
		...
		try {
			...
			firstAuthor.setBio("Some very Long Personal Line of Biodata here");
			firstAuthor.setImage("Pretend this is an image content".getBytes());
			Author secondAuthor = new Author("James Goshling", new GregorianCalendar(1975,  2, 0, 04, 10, 01).getTime());
			secondAuthor.setImage("Pretned this is also an image content".getBytes());
