...
/**
 * Demonstrate Update Operation on JPA, and demonstrate how persistance.xml can initiate to load pre-loaded insert statement data in META-INF/preload-query.sql
 * 
 ...
 *   
 *  2.  Demonstrate how to update a data using JPA,
...
public class UpdateExample {
	...
	public void runMain() {
		...
		try {
			...
			bookTwo.setTitle("Core Java Volumne I - Fundamentals");			
