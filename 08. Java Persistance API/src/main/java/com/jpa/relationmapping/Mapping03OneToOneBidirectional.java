...
/**
 * Demonstrate One To One Relationship Bidirectional Mapping
 * 
 ...
 *  	@OneToOne(mappedBy = {reference to a field name of the referenced Entity}
 *  
 *  Mapping : 
 *  	bills <-> trans_statement (invoice)
 *
 */
